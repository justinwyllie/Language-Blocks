...
class KeaActivities
{
    ...
    public function wporg_register_taxonomy_english() {
        ...
        $target_post_types_levels[] = "kea_activity";
        ...
        */
        ...
        $target_post_types_age_bands[] = "kea_activity";
        ...
        */
        ...
        $target_post_types_grammar[] = "kea_activity";
        ...
        */
        ...
        register_taxonomy( 'russian_grammar', array( 'activity_gap_fill', 'kea_activity' ), $args);
...
class KeaActivities2
{
    ...
    public function __construct() 
    {
        ...
        //add_action( 'init', array($this, 'activity_register_block' ));
        //add_action( 'init', array($this, 'add_t' ));
...
$kea_activities2 = new KeaActivities2();
