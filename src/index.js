...
const GapFillQuestion = ({values,
    ...
    removeQuestion}) =>
{
    console.log("GapFillQuestion" , values, idx, errors);
    return(
    <div> 
        <Form.Group as={Row}>
...
registerBlockType( 'activities/activity-gap-fill', {
    ...
    edit: ( { setAttributes, attributes } ) => {
        ...
        const metaFieldValue = meta[ '_activity_gap_fill_meta' ]; 
        ...
        console.log("initialValues in edit", initialValues);
        useEffect(() => {

            function initaliseForm() {
                console.log("initaliseForm");
                ...
                else //set initialValues for form based on XML string loaded from postmeta
                {
                    ...
                    {
                        questionNodes.forEach((el) => { 
                            initialValues.questions.push({question: el.childNodes[0].nodeValue, 
                    ...
                    if (instructionsNodes != null)
                    {
                        ...
                        console.log("hinstructionsLangNodes", instructionsLangNodes);
                        let textForBox;
                ...
                console.log("initialValues in useEffect", initialValues);
                //actually setting initialValues does not cause a rerender
                //but this is messy - convert to class...? todo...
                forceUpdate();
            }
            initaliseForm();
            }, []);//empty array to useEffect means this = componentdidmount - only run on mount
            //but todo problematic because it will render again after mounting as state is changing...
        ...
        function setInstructionsLangHandler(event)
        {
            ...
            console.log("instructions[currentLang]", instructions[currentLang]);
        }
        ...
        function processForm(values)
        {
            ...
            console.log("instructions",instructions);//TODO does this have to use own state???
            ...
            console.log("newXmlStr set in process form", newXmlStr);
